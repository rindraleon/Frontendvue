<template>
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    ...
    <div class="flex items-center space-x-1 text-xs">
      <a href="#" class="font-bold text-indigo-700">Accueil</a>
  ...
  <div class="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-4 sm:px-8">
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
      ...
      <div class="px-4 text-gray-700">
        <h3 class="text-sm tracking-wider">Total Chrétiens</h3>
    ...
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
      ...
      <div class="px-4 text-gray-700">
        <h3 class="text-sm tracking-wider">Total APF</h3>
    ...
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
      ...
      <div class="px-4 text-gray-700">
        <h3 class="text-sm tracking-wider">Total Eglise</h3>
    ...
    <div class="flex items-center bg-white border rounded-sm overflow-hidden shadow">
      ...
      <div class="px-4 text-gray-700">
        <h3 class="text-sm tracking-wider">Sacrements</h3>
  ...
  <div class="grid grid-cols-1 px-4 gap-4 mt-8 sm:grid-cols-3 sm:px-8">
    <div class="px-4 py-2 bg-white border rounded-md overflow-hidden shadow">
      <h3 class="text-xl text-gray-600 mb-4">Bilan graphique</h3>
      <apexchart type="area" :height="300" :options="pageViewOptions" :series="pageViewSeries"></apexchart>
    </div>

    <div class="px-4 py-2 bg-white border rounded-md overflow-hidden shadow">
      <h3 class="text-xl text-gray-600 mb-4">Associations spurituelle</h3>
    ...
    <div class="grid grid-rows-2 gap-4">
      <div class="px-4 py-2 bg-white border rounded-md shadow">
        <h3 class="text-xl text-gray-600 mb-2">Resource humaine</h3>
            ...
            <div class="overflow-hidden border-0">
              <table class="table-auto min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200 text-sm text-gray-500">
                  <tr>
                    <td class="py-1">Rakoto solofo</td>
                    <td class="py-1 text-sm text-gray-500">Curé</td>
                  </tr>
                  <tr>
                    <td class="py-1">Rabialahy</td>
                    <td class="py-1 text-sm text-gray-500">Président</td>
                  </tr>
                  <tr>
